...
"There are so many places to go in Europe for a vacation--Paris, Rome, Prague, etc.All the grandfather clocks in that store were set at exactly 3 o’clock.",
...
let cpm_group = document.querySelector(".curr_cpm");
let wpm_group = document.querySelector(".curr_wpm");
...
input_area.value = "";
quote_text.textContent = 'Click on the area below to start the Typing.';
accuracy_text.textContent = 100;
cpm_group.textContent = 0;
wpm_group.textContent = 0;
